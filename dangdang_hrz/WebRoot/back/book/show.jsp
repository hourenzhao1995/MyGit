...
<html>
  ...
  <body style="background-color: #f0f9fd;">
  	...
  	<div style="margin: 0 auto;text-align:center;">
  		<form action="${pageContext.request.contextPath }/book/queryBookByKey" method="post">
  			<input onclick="location.href='${pageContext.request.contextPath}/book/querySeconds'" class="button btn-p" value="添加图书&raquo;" />&emsp;&emsp;
  	...
  	<table bordercolor='#898E90' align='center' border='3px' cellpadding='5px' cellspacing="0px" >
  		...
  		<c:forEach items="${list}" var="book">
  			<tr align='center'>
				...
				<td>${book.stock }</td>
				<td>
					<input  class="button"  onclick="location.href='${pageContext.request.contextPath }/book/queryBookById?id=${book.id}'" value="修改 " />
					<input class="button-del" onclick="location.href='${pageContext.request.contextPath }/book/removeBookById?id=${book.id }'" value="删除 " />
				</td>
	  		</tr>
  		</c:forEach>
