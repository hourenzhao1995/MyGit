...
<html>
  ...
  <body style="text-align: center;background-color: #d4e7f0">  <!-- #f0f9fd -->
   	...
   	<div style="text-align: center" class="div1">
   		<div class="aa">
			<a style="text-decoration: none;" href="${pageContext.request.contextPath }/category/showAll" target="Homepage">类别管理</a><br/><br/>
		</div>
		<div class="aa">
  			<a style="text-decoration: none;" href="${pageContext.request.contextPath }/book/queryAllBook"  target="Homepage">图书管理</a><br/><br/>
  		</div>
  		<div class="aa">
