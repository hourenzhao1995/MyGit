			...
			<p>
				...
				<script type="text/javascript">
					function changeAddress(addressId){
						window.location.href="${pageContext.request.contextPath}/address/queryAddressById?addressId="+addressId;
					}
				</script>
			</p>
			<form name="ctl00" method="post" action="${pageContext.request.contextPath }/address/addAddress" id="f">
