			...
			<form name="ctl00" method="post" action="${pageContext.request.contextPath }/user/adduser" id="f" onsubmit="return check()">
				...
				<table class="tab_login" >
					...
					<tr>
						...
						<td>
							<img class="yzm_img" id='imgVcode' src="${pageContext.request.contextPath }/admin/execute" />
								...
								<p class="t1">
									...
									<script type="text/javascript">
										$("#change").on("click",function(){
											$("#imgVcode").attr("src","${pageContext.request.contextPath }/admin/execute?t="+Math.random());
										});
										$("#imgVcode").on("click",function(){
											//$("#imgVcode").attr("src","<s:url value="/user/getCode"/>?t="+Math.random());
											$(this).attr("src","${pageContext.request.contextPath }/admin/execute?t="+Math.random());
										});
										function checkCode(){
